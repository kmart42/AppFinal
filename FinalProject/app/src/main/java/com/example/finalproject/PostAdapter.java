...
public class PostAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.ViewHolder> {

//    private String[] localDataSet;
    private List<CategoryView.MiniPost> postsList;
...
//    }
    public PostAdapter(List<CategoryView.MiniPost> dataSet) {
        postsList = dataSet;
    }
    ...
    public void onBindViewHolder(@NonNull MyRecyclerAdapter.ViewHolder holder, final int position) {
        final CategoryView.MiniPost u =postsList.get(position);
